...
DY = 40e3;
DT_FACTOR = 10; % Might need to be increased to ensure stability
...
%% Initial conditions
%% Set initial conditions for layer height, eastward velocity, and northward velocity
% rest
h0 = ones(size(X_H)) * D;
u0 = zeros(size(X_U));
v0 = zeros(size(X_V));
...
while t < T1
    ...
    %% output - Update and display visualization
    plot_h.ZData = h;
